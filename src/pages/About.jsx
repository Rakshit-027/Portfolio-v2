    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto py-20">
          ...
          >
            <h1 className="text-4xl font-Tajawal-bold mb-4">About Me</h1>
            <p className="text-gray-500 max-w-2xl font-Tajawal mx-auto">
              I'm a passionate developer with over 2 years of experience in creating web applications.
          ...
          >
            ...
            <article className="bg-gray-800 p-8 rounded-lg">
              <p className="text-gray-400 leading-relaxed">
                I started my journey as a web developer in 2023, focusing primarily on frontend development.
                Over the years, I've worked with various technologies and frameworks, constantly learning
                and adapting to new challenges. My experience includes working with startups and large
                enterprises, helping them build scalable and maintainable web applications.
              </p>
            </article>
          </motion.div>
        </div>
